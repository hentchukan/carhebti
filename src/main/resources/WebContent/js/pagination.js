...
function paginate() {
    ...
    var number_of_items = $('#content').find("tr.line.pagination").length; 
    ...
    */  
    ...
    $('#content').find("tr.line").css('display', 'none');  
  
    //and show the first n (show_per_page) elements  
    $('#content').find("tr.line.pagination").slice(0, show_per_page).css('display', 'table-row');  
}
...
function go_to_page(page_num){  
    ...
    $('#content').find("tr.line").css('display', 'none').slice(start_from, end_on).css('display', 'table-row');  
